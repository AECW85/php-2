     ...
     $j=$j-2;
        ...
        */
        ...
        // Lakukan Looping di sini
         $hasil = [];
         $pembagi=5;
         $jumlah_data= count($numbers);

         for ( $x = 0 ; $x < $jumlah_data ; $x++)
         {
           $mod5 = $numbers[$x] % $pembagi;
           $hasil[$x] = $mod5;         
         }
        ...
        */
        ...
        $jml_lines=count($items);
        for($i=0 ; $i <$jml_lines ; $i++)
        {
            $array_assoc[$i][id]=$items[$i][0];
            $array_assoc[$i][name]=$items[$i][1];
            $array_assoc[$i][price]=$items[$i][2];
            $array_assoc[$i][description]=$items[$i][3];
            $array_assoc[$i][source]=$items[$i][4];
